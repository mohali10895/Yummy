...
let categoriesItem = document.querySelector('#categoriesItem');
...
let ingredientsItem = document.querySelector('#ingredientsItem');
ingredientsItem.addEventListener('click',function(){
    getIngredients(); 
    closeSideNav();
})
